...
var domready, app, router, vp;
domready = require('domready');
app = require('./modules/app.ls');
router = require('./modules/router.ls');
vp = require('./modules/viewport.ls');
app.extend({
...
st = model.extend {
  ...
  derived:
    signedIn:
      deps: ['token']
      fn: ->
        if @token is '' then false else true
}

vu = view.extend {
  template: require './templates/vu.jade'
  initialize: (opts) ->
  ...
  bindings:
    ...
    'model.signedIn':
      type: 'toggle'
      no: '[data-hook=signedout]'
      yes: '[data-hook=signedin]'
  events:
    'click .signin': "signin"
    'click .signout': "signout"
  signin: ->
    console.log stt.token
    console.log 'signin'
    stt.set token: 'xoxo'
  signout: ->
    console.log stt.token
...
stt = new st
vue = new vu model: stt, el: document.body
vue.render!
stt.set token: 'xoxo'
*/
},{"./modules/app.ls":10,"./modules/router.ls":11,"./modules/viewport.ls":14,"domready":161}],2:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var templates, formview, inputview, xtendedinput;
...
},{"../../templates.js":165,"ampersand-form-view":67,"ampersand-input-view":71}],3:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var templates, formview, inputview, xtendedinput;
templates = require('../../templates.js');
formview = require('ampersand-form-view');
...
},{"../../templates.js":165,"ampersand-form-view":67,"ampersand-input-view":71}],4:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var model;
model = require('ampersand-model');
...
},{"ampersand-model":72}],5:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var track, collection;
...
},{"./track.ls":4,"ampersand-rest-collection":93}],6:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var model;
model = require('ampersand-model');
module.exports = model.extend({
...
},{"ampersand-model":72}],7:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var user, collection;
...
},{"./user.ls":6,"ampersand-rest-collection":93}],8:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var model;
model = require('ampersand-model');
module.exports = model.extend({
...
},{"ampersand-model":72}],9:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var video, collection;
video = require('./video.ls');
collection = require('ampersand-rest-collection');
module.exports = collection.extend({
  model: video,
  url: '/videos'
});
},{"./video.ls":8,"ampersand-rest-collection":93}],10:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var app, session, viewport, user, users, video, tracks, videos;
app = require('ampersand-app');
session = require('./sess.ls');
viewport = require('./viewport.ls');
user = require('../models/user.ls');
users = require('../models/users.ls');
video = require('../models/video.ls');
tracks = require('../models/tracks.ls');
videos = require('../models/videos.ls');
app.extend({
  user: new user(),
  users: new users(),
  video: new video(),
...
module.exports = app;
},{"../models/tracks.ls":5,"../models/user.ls":6,"../models/users.ls":7,"../models/video.ls":8,"../models/videos.ls":9,"./sess.ls":12,"./viewport.ls":14,"ampersand-app":23}],11:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var app, router, homepage, mixespage, videospage, signuppage, signinpage, listenpage;
app = require('ampersand-app');
router = require('ampersand-router');
homepage = require('../pages/home.ls');
mixespage = require('../pages/mixes.ls');
videospage = require('../pages/videos.ls');
signuppage = require('../pages/signup.ls');
signinpage = require('../pages/signin.ls');
listenpage = require('../pages/listen.ls');
module.exports = router.extend({
  ...
  mixes: function(){
    this.trigger('page', new mixespage);
  },
  signup: function(){
    this.trigger('page', new signuppage);
  },
  signin: function(){
    this.trigger('page', new signinpage);
  },
  videos: function(){
    this.trigger('page', new videospage({
      collection: app.videos
    }));
  },
  listen: function(){
    this.trigger('page', new listenpage({
      collection: app.tracks
    }));
  }
});
},{"../pages/home.ls":15,"../pages/listen.ls":16,"../pages/mixes.ls":17,"../pages/signin.ls":18,"../pages/signup.ls":19,"../pages/videos.ls":20,"ampersand-app":23,"ampersand-router":119}],12:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var model;
model = require('ampersand-model');
module.exports = model.extend({
...
},{"ampersand-model":72}],13:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, templates;
view = require('ampersand-view');
templates = require('../../templates.js');
module.exports = view.extend({
  template: templates.includes.video,
  bindings: {
    'model.title': {
      type: 'text',
      hook: 'title'
...
},{"../../templates.js":165,"ampersand-view":132}],14:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var domify, app, view, sessview, vs, templates;
domify = require('domify');
app = require('ampersand-app');
view = require('ampersand-view');
sessview = require('../views/session.ls');
...
module.exports = view.extend({
  ...
  initialize: function(opts){
    ...
    return this.listenTo(app.router, 'page', this.handlenewpage);
  },
  events: {
  ...
  render: function(){
    ...
    this.port = new vs(this.queryByHook('port', {
      show: function(next, prev){
        return app.currentpage = next;
      }
    }));
    return this;
  },
  handlelinkclick: function(e){
    var local;
    local = e.target === window.location.host;
    e.preventDefault();
    return app.navigate(e.target.pathname);
  },
  handlenewpage: function(view){
    return this.port.set(view);
  },
  handleauth: function(credentials){
    return app.session.set(credentials);
  }
});
},{"../../templates.js":165,"../views/session.ls":21,"ampersand-app":23,"ampersand-view":132,"ampersand-view-switcher":131,"domify":160}],15:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, templates;
view = require('ampersand-view');
templates = require('../../templates.js');
...
},{"../../templates.js":165,"ampersand-view":132}],16:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, trackview, templates;
view = require('ampersand-view');
trackview = require('../views/track.ls');
templates = require('../../templates.js');
module.exports = view.extend({
  template: templates.pages.listen,
  render: function(){
    this.renderWithTemplate();
    this.renderCollection(this.collection, trackview, this.queryByHook('tracks'));
...
},{"../../templates.js":165,"../views/track.ls":22,"ampersand-view":132}],17:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, templates;
view = require('ampersand-view');
templates = require('../../templates.js');
module.exports = view.extend({
  template: templates.pages.mixes
});
},{"../../templates.js":165,"ampersand-view":132}],18:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var app, request, view, templates, signinform;
app = require('ampersand-app');
request = require('superagent');
view = require('ampersand-view');
templates = require('../../templates.js');
signinform = require('../forms/signin.ls');
module.exports = view.extend({
...
},{"../../templates.js":165,"../forms/signin.ls":2,"ampersand-app":23,"ampersand-view":132,"superagent":162}],19:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var app, view, templates, signupform;
app = require('ampersand-app');
view = require('ampersand-view');
templates = require('../../templates.js');
signupform = require('../forms/signup.ls');
module.exports = view.extend({
    ...
    form: {
      ...
      prepareView: function(el){
        return new signupform({
          el: el,
          submitCallback: function(data){
            return app.users.create(data, {
              wait: true,
              success: function(col, res, opt){
                console.log(res);
                app.trigger('auth', res);
                return app.navigate('/');
              }
            });
          }
...
},{"../../templates.js":165,"../forms/signup.ls":3,"ampersand-app":23,"ampersand-view":132}],20:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, templates, itemview;
view = require('ampersand-view');
templates = require('../../templates.js');
itemview = require('../modules/video.ls');
module.exports = view.extend({
  template: templates.pages.videos,
  render: function(){
    this.renderWithTemplate();
    this.renderCollection(this.collection, itemview, this.queryByHook('videos'));
    if (!this.collection.length) {
      return this.fetchCollection();
    }
  },
...
},{"../../templates.js":165,"../modules/video.ls":13,"ampersand-view":132}],21:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var app, view, templates;
app = require('ampersand-app');
view = require('ampersand-view');
templates = require('../../templates.js');
module.exports = view.extend({
  template: templates.includes.session,
  initialize: function(){
    return this.listenTo(app, 'auth', this.handleauth);
  },
  handleauth: function(credentials){
    return app.session.set(credentials);
  },
  bindings: {
    'session.signedIn': {
      type: 'toggle',
      no: '[data-hook=anonymous-user]',
      yes: '[data-hook=authenticated-user]'
    }
  }
});
},{"../../templates.js":165,"ampersand-app":23,"ampersand-view":132}],22:[function(require,module,exports){
// Generated by LiveScript 1.3.1
var view, templates;
view = require('ampersand-view');
templates = require('../../templates.js');
...
},{"../../templates.js":165,"ampersand-view":132}],23:[function(require,module,exports){
...
},{"amp-extend":24,"amp-to-array":46,"ampersand-events":47}],24:[function(require,module,exports){
...
},{"amp-is-object":25}],25:[function(require,module,exports){
...
},{"amp-iteratee":28,"amp-keys":35}],28:[function(require,module,exports){
...
},{"amp-create-callback":29,"amp-is-function":30,"amp-is-object":31,"amp-matches":32,"amp-property":34}],29:[function(require,module,exports){
...
},{"amp-pairs":33}],33:[function(require,module,exports){
var objKeys = require('amp-keys');
...
},{"amp-keys":35}],34:[function(require,module,exports){
...
},{"amp-has":36,"amp-index-of":37,"amp-is-object":39}],36:[function(require,module,exports){
...
},{"amp-has":41,"amp-index-of":42,"amp-is-object":44,"dup":35}],41:[function(require,module,exports){
arguments[4][36][0].apply(exports,arguments)
},{"dup":36}],42:[function(require,module,exports){
arguments[4][37][0].apply(exports,arguments)
},{"amp-is-number":43,"dup":37}],43:[function(require,module,exports){
...
},{"amp-keys":40}],46:[function(require,module,exports){
...
},{"amp-is-array":26,"amp-map":27,"amp-values":45}],47:[function(require,module,exports){
...
},{"amp-bind":48,"amp-each":51,"amp-extend":24,"amp-is-empty":53,"amp-keys":59,"amp-once":65,"amp-unique-id":66}],48:[function(require,module,exports){
var isFunction = require('amp-is-function');
var isObject = require('amp-is-object');
...
},{"amp-is-function":49,"amp-is-object":50}],49:[function(require,module,exports){
...
},{"amp-create-callback":52,"amp-keys":59}],52:[function(require,module,exports){
...
},{"amp-is-arguments":54,"amp-is-array":55,"amp-is-nan":56,"amp-is-number":57,"amp-is-string":58,"amp-keys":59}],54:[function(require,module,exports){
var toString = Object.prototype.toString;
var hasOwn = Object.prototype.hasOwnProperty;
...
},{"amp-is-number":57}],57:[function(require,module,exports){
arguments[4][38][0].apply(exports,arguments)
...
arguments[4][35][0].apply(exports,arguments)
},{"amp-has":60,"amp-index-of":61,"amp-is-object":63,"dup":35}],60:[function(require,module,exports){
arguments[4][36][0].apply(exports,arguments)
},{"dup":36}],61:[function(require,module,exports){
arguments[4][37][0].apply(exports,arguments)
},{"amp-is-number":62,"dup":37}],62:[function(require,module,exports){
arguments[4][38][0].apply(exports,arguments)
...
},{"amp-limit-calls":64}],66:[function(require,module,exports){
(function (global){
...
},{"backbone-events-standalone":69,"extend-object":70}],68:[function(require,module,exports){
/**
...
},{"./backbone-events-standalone":68}],70:[function(require,module,exports){
var arr = [];
...
},{"ampersand-view":132}],72:[function(require,module,exports){
...
},{"ampersand-state":73,"ampersand-sync":78,"underscore":92}],73:[function(require,module,exports){
...
},{"array-next":74,"backbone-events-standalone":76,"key-tree-store":77,"underscore":92}],74:[function(require,module,exports){
...
},{"./backbone-events-standalone":75,"dup":69}],77:[function(require,module,exports){
...
},{"qs":79,"underscore":84,"xhr":85}],79:[function(require,module,exports){
...
},{"buffer":156}],83:[function(require,module,exports){
(function (Buffer){
// Load modules
...
},{"buffer":156}],84:[function(require,module,exports){
//     Underscore.js 1.6.0
...
},{"for-each":88,"trim":90}],92:[function(require,module,exports){
//     Underscore.js 1.7.0
//     http://underscorejs.org
//     (c) 2009-2014 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
//     Underscore may be freely distributed under the MIT license.
...
},{"ampersand-collection":112,"ampersand-collection-rest-mixin":94,"ampersand-collection-underscore-mixin":110}],94:[function(require,module,exports){
...
},{"ampersand-sync":95,"extend-object":109}],95:[function(require,module,exports){
arguments[4][78][0].apply(exports,arguments)
},{"dup":78,"qs":96,"underscore":101,"xhr":102}],96:[function(require,module,exports){
arguments[4][79][0].apply(exports,arguments)
},{"./lib":97,"dup":79}],97:[function(require,module,exports){
arguments[4][80][0].apply(exports,arguments)
},{"./parse":98,"./stringify":99,"dup":80}],98:[function(require,module,exports){
arguments[4][81][0].apply(exports,arguments)
},{"./utils":100,"dup":81}],99:[function(require,module,exports){
arguments[4][82][0].apply(exports,arguments)
},{"buffer":156,"dup":82}],100:[function(require,module,exports){
arguments[4][83][0].apply(exports,arguments)
},{"buffer":156,"dup":83}],101:[function(require,module,exports){
arguments[4][84][0].apply(exports,arguments)
},{"dup":84}],102:[function(require,module,exports){
arguments[4][85][0].apply(exports,arguments)
},{"dup":85,"global/window":103,"once":104,"parse-headers":108}],103:[function(require,module,exports){
arguments[4][86][0].apply(exports,arguments)
},{"dup":86}],104:[function(require,module,exports){
arguments[4][87][0].apply(exports,arguments)
},{"dup":87}],105:[function(require,module,exports){
arguments[4][88][0].apply(exports,arguments)
},{"dup":88,"is-function":106}],106:[function(require,module,exports){
arguments[4][89][0].apply(exports,arguments)
},{"dup":89}],107:[function(require,module,exports){
arguments[4][90][0].apply(exports,arguments)
},{"dup":90}],108:[function(require,module,exports){
arguments[4][91][0].apply(exports,arguments)
},{"dup":91,"for-each":105,"trim":107}],109:[function(require,module,exports){
...
},{"underscore":111}],111:[function(require,module,exports){
...
},{"ampersand-class-extend":113,"backbone-events-standalone":115,"extend-object":116,"is-array":117}],113:[function(require,module,exports){
...
},{"extend-object":116}],114:[function(require,module,exports){
arguments[4][68][0].apply(exports,arguments)
},{"dup":68}],115:[function(require,module,exports){
arguments[4][69][0].apply(exports,arguments)
},{"./backbone-events-standalone":114,"dup":69}],116:[function(require,module,exports){
arguments[4][70][0].apply(exports,arguments)
...
},{"amp-bind":120,"amp-extend":122,"backbone-events-standalone":130}],119:[function(require,module,exports){
...
},{"./ampersand-history":118,"amp-extend":122,"amp-is-function":124,"amp-is-regexp":125,"amp-result":126,"ampersand-class-extend":127,"backbone-events-standalone":130}],120:[function(require,module,exports){
arguments[4][48][0].apply(exports,arguments)
},{"amp-is-function":124,"amp-is-object":121,"dup":48}],121:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
},{"dup":25}],122:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"amp-is-object":123,"dup":24}],123:[function(require,module,exports){
arguments[4][25][0].apply(exports,arguments)
...
},{"amp-is-function":124}],127:[function(require,module,exports){
arguments[4][113][0].apply(exports,arguments)
},{"dup":113,"extend-object":128}],128:[function(require,module,exports){
arguments[4][70][0].apply(exports,arguments)
},{"dup":70}],129:[function(require,module,exports){
arguments[4][68][0].apply(exports,arguments)
},{"dup":68}],130:[function(require,module,exports){
arguments[4][69][0].apply(exports,arguments)
},{"./backbone-events-standalone":129,"dup":69}],131:[function(require,module,exports){
...
},{"ampersand-collection-view":133,"ampersand-dom-bindings":138,"ampersand-state":141,"domify":146,"events-mixin":147,"get-object-path":152,"matches-selector":153,"underscore":154}],133:[function(require,module,exports){
...
},{"ampersand-class-extend":134,"backbone-events-standalone":137,"underscore":154}],134:[function(require,module,exports){
arguments[4][113][0].apply(exports,arguments)
},{"dup":113,"extend-object":135}],135:[function(require,module,exports){
arguments[4][70][0].apply(exports,arguments)
...
arguments[4][69][0].apply(exports,arguments)
},{"./backbone-events-standalone":136,"dup":69}],138:[function(require,module,exports){
...
},{"ampersand-dom":139,"key-tree-store":140,"matches-selector":153}],139:[function(require,module,exports){
...
},{"array-next":142,"backbone-events-standalone":144,"dup":73,"key-tree-store":145,"underscore":154}],142:[function(require,module,exports){
arguments[4][74][0].apply(exports,arguments)
},{"dup":74}],143:[function(require,module,exports){
arguments[4][68][0].apply(exports,arguments)
},{"dup":68}],144:[function(require,module,exports){
arguments[4][69][0].apply(exports,arguments)
},{"./backbone-events-standalone":143,"dup":69}],145:[function(require,module,exports){
...
},{"component-event":148,"delegate-events":149}],148:[function(require,module,exports){
...
},{"closest":150,"event":148}],150:[function(require,module,exports){
var matches = require('matches-selector')
...
},{"matches-selector":151}],151:[function(require,module,exports){
...
},{"dup":117}],160:[function(require,module,exports){
arguments[4][146][0].apply(exports,arguments)
},{"dup":146}],161:[function(require,module,exports){
/*!
...
(function (root, factory) {
    ...
    // includes/item.jade compiled template
    templatizer["includes"]["item"] = function tmpl_includes_item() {
        return '<li class="list-item"><div class="grid-flex-container"><div class="grid-flex-cell grid-flex-cell1of4"><figure class="media-outlined"><img data-hook="avatar" width="40" height="40"/><figcaption></figcaption></figure></div><div class="grid-flex-cell"><ul><li><a data-hook="title"></a></li><li><blockquote><p data-hook="artist"></p></blockquote></li><li><p>button collection</p></li></ul></div></div></li>';
    };

    // includes/session.jade compiled template
    templatizer["includes"]["session"] = function tmpl_includes_session() {
        return '<div class="user-session"><div data-hook="anonymous-user"><div class="list-unstyled list-inline cf"><li><a href="/signin">Sign in</a></li><li><a href="/signup">Sign up</a></li></div></div><div data-hook="authenticated-user"><img href="http://placekitten.com/g/300/300" class="avatar avatar-large avatar-rounded"/></div></div>';
    };

    // includes/track.jade compiled template
    templatizer["includes"]["track"] = function tmpl_includes_track() {
        return '<ul class="track list-unstyled"><li class="track-avatar"><img data-hook="avatar" class="avatar avatar-medium avatar-rounded"/></li><li class="track-name"><div data-hook="name"></div></li><li class="track-duration"><div data-hook="duration"></div></li></ul>';
    };
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<div class="grid-flex-container port"><div class="grid-flex-cell"><nav role="navigation"><ul class="list-unstyled list-inline tabs"><li><a class="current-item">New releases</a></li><li><a>Top of the chart</a></li><li><a>East African</a></li><li><a>West African</a></li><li><a>South African</a></li></ul></nav></div><div class="grid-flex-cell grid-flex-cell-1of3"><blockquote><p>I\'j just saying you can do better</p></blockquote></div></div>';
    };

    // pages/listen.jade compiled template
    templatizer["pages"]["listen"] = function tmpl_pages_listen() {
        return '<section class="media"><article class="player"><aside class="current"><section class="track"><article class="metadata"><p>media details</p></article><aside class="thumbnail"><p>media thumbnail</p></aside></section><nav class="control"><p>waveform</p></nav></aside><article class="playlist"><section data-hook="tracks"> </section></article></article><aside class="info"><blockquote><p>captioned figure</p></blockquote><blockquote><p>artist || band bio</p></blockquote></aside></section>';
    };

    // pages/mixes.jade compiled template
    templatizer["pages"]["mixes"] = function tmpl_pages_mixes() {
        return "<blockquote><p>i'm just saying you could do better</p></blockquote>";
    };
    ...
    templatizer["viewport"] = function tmpl_viewport() {
        return '<body><nav role="navigation" class="top-nav top-nav-dark cf"><div class="toolbar"><div class="logo"><div class="list-unstyled list-inline cf"><li><a href="/listen">Songs</a></li><li><a href="/videos">Videos</a></li><li><a href="/videos">Mixes</a></li></div></div><div class="nav"><input type="search" placeholder="search mixes, music and artists" class="search"/></div><div data-hook="session" class="not"><div data-hook="anonymous"><ul class="list-unstyled list-inline cf"><li><a href="/signin">Sign in</a></li><li><a href="/signup">Sign up</a></li></ul></div><div data-hook="authenticated"><ul class="list-unstyled list-inline cf"><li><a class="signout">Sign out</a></li></ul></div></div></div></nav><div><blockquote><p data-hook="token">                 </p></blockquote></div><section data-hook="port"></section></body>';
    };

    // vu.jade compiled template
    templatizer["vu"] = function tmpl_vu() {
        return '<div class="user-session"><button class="signin">sign in</button><button class="signout">signout</button><p data-hook="token"></p><blockquote><p data-hook="signedin">signed in</p></blockquote><blockquote><p data-hook="signedout">signed out</p></blockquote></div>';
    };
